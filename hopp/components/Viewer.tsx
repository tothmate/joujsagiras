...
import { Box, Grid, Hidden, makeStyles, TextField, Typography } from '@material-ui/core';
      ...
      {props.sticker.reason.text && (
        <Hidden xsDown>
          <Grid item xs={12} sm={1}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1580 1620" className={classes.arrow}>
              <g fill="#979797">
                <g>
